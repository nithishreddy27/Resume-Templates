  ...
  return (
    <div className="">
      ...
      <main className="flex justify-center">
        <div className="container w-[210mm] h-[290mm] min-w-[210mm] flex bg-white text-black">
          <div className="first w-[85mm] h-[290mm] bg-slate-300">
            <div className="photo">
          ...
          <div className="second bg-slate-100 w-[125mm] h-[290mm]">
            <div className="name">
