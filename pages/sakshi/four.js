  ...
  return (
    <div className="">
      ...
      <main className="flex justify-center">
        <div className="container w-[210mm] h-[290mm] min-w-[210mm] bg-white flex">
          <div className="first w-[85mm] h-[290mm] bg-emerald-700">
          ...
          <div className="second bg-emerald-100 w-[125mm] h-[290mm]">
            <div className="name">
