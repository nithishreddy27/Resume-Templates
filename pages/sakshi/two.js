    ...
    <div className={styles.container}>
        ...
        <main className={styles.main}>
            <div className="container w-[210mm] h-[297mm] min-w-[210mm] bg-white text-black">
                <div className="first w-[210mm] h-[30mm] mt-5 bg-zinc-300 flex">
                ...
                <div className="second flex">
                    <div className="side1 w-[85mm]"> 
                        <div className="contact  border-b-2 border-r-2 border-gray-500 mx-6 mt-5">
                            <div className="dob pl-10 pt-1 text-sm"><i className='bx bxs-calendar pr-4 text-lg'></i><span className=" relative bottom-[3px]">{resume.personal.dob}</span></div>
                            <div className="phone pl-10 pt-1 text-sm"><i className='bx bxs-phone pr-4 text-lg'></i><span className=" relative bottom-1">{resume.personal.phone}</span></div>
                            <div className="mail pl-10 pt-1 text-sm"><i className='bx bxs-envelope pr-4 text-lg'></i><span className=" relative bottom-1">{resume.personal.email}</span></div>
                        ...
                        <div className="education border-b-2 border-r-2 border-gray-500 mx-6">
                            ...
                            <h2 className="text-center text-base font-serif font-bold underline pt-2">E D U C A T I O N</h2>
                            {
                                resume.education.map(item=>(
                                    <p className="pl-10 pr-5 pt-2 text-sm"><span className="font-medium">{item.institution}</span> in <span className="font-medium">{item.fieldOfStudy}<br/>({item.startDate} to {item.endDate})</span><br/><i class='bx bxs-graduation'></i> {item.typeOfDegree} in {item.fieldOfStudy} ({item.gpa})</p>
                                ))
                            }
                            </div>
                            <div className="w-3 h-3 rounded-full border-2 border-gray-500 relative left-[266px] bottom-[-5px] bg-white "></div>
                        ...
                        <div className="certifications border-r-2 border-b-2 border-gray-500 mx-6">
                            ...
                            <h2 className="text-center text-base font-serif font-bold underline pt-2 pb-2">C E R T I F I C A T I O N S</h2>
                            {
                                resume.certifications.map(item=>(
                                    <p className="pl-10 pr-2 pb-1 text-sm"><i className='bx bxs-square text-xs pr-3'></i>{item.title} from {item.issuer}</p>
                                ))
                            }
                            </div>
                            <div className="w-3 h-3 rounded-full border-2 border-gray-500 relative left-[266px] bottom-[-5px] bg-white "></div>
                    ...
                    <div className="projects border-gray-500 ml-[-24px] mr-5">
