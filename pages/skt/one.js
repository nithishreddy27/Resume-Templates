    ...
    <div>
      ...
      <div class="bg-gray-300 flex align-middle justify-center">
        <div class="container main-page bg-white w-[210mm] h-[297mm] m-10 overflow-auto drop-shadow-2x  p-0">
          <div>
            <div class="grid grid-cols-4 gap-3 h-auto">
              ...
              <div class="bg-yellow-400 col-span-3 flex flex-col  h-40">
                <h1 class="text-5xl font-semibold px-12 border-l py-4 ">
                  {resume.personal.firstName}{" "}
                </h1>
                <h1 class="text-5xl font-semibold px-12 ">
          ...
          <div>
            <div class="bg-white h-auto py-4  px-16 ">
              <h2 class="text-white bg-neutral-900 p-1 text-center w-[25%] mx-auto">DETAILS</h2>
              {
            ...
            <div class="bg-white h-auto py-2  px-16">
              <h2 class="text-white bg-neutral-900 p-1 w-[25%] mx-auto text-center">PROFILE</h2>
              <h4 className="mt-3">{resume.objective}</h4>
            </div>
        ...
        <div className="flex my-10">
            ...
            <div class="bg-white h-auto py-2 px-16">
              <h1 className="text-white bg-neutral-900 inline p-1">
                EDUCATION
              </h1>
              {resume.education.map((item) => (
                <div className="my-4">
                  ...
                  <li className="text-black px-5  font-sm list-disc">
                    {item.fieldOfStudy}
                  </li>
                  <li className="text-black px-5  font-sm list-disc">
                    {item.typeOfDegree}
            ...
            <div>
              <div class="bg-white h-auto py-2 px-16">
                <h2 class="text-white bg-neutral-900  inline p-1 w-[25%]">SKILLS</h2>
                {resume.skills.map((item) => (
                  <div>
                    <h1 className="text-black font-medium mr-6 mt-4">{item.name}</h1>
                ...
                <h2 class="text-white bg-neutral-900 inline p-1 ml-16 ">
              LANGUAGES
                 </h2>
                </div>
                 <div class="bg-white h-auto py-2 px-16 ">
              {resume.languages.map((item) => (
                <div>
                  <h1 className="text-black font-medium mr-6 mt-6">{item.name}</h1>
                  <h1 className="text-gray-600 font-sm mr-6 px-5">
                    {item.fluency}
                  </h1>
                </div>
              ))}
